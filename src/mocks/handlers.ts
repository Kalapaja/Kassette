  ...
  invoice: {
    ...
    cart: {
      items: [
        ...
        {
          name: 'Artisan Sprocket',
          quantity: 1,
          price: '0.05',
          image_url: 'https://api.dicebear.com/7.x/shapes/svg?seed=sprocket3',
        },
        {
          name: 'Hand-woven Mesh',
          quantity: 3,
          price: '0.02',
          image_url: 'https://api.dicebear.com/7.x/shapes/svg?seed=mesh4',
        },
        {
          name: 'Heritage Fastener',
          quantity: 1,
          price: '0.08',
          image_url: 'https://api.dicebear.com/7.x/shapes/svg?seed=fastener5',
        },
        {
          name: 'Polished Connector',
          quantity: 2,
          price: '0.03',
          image_url: 'https://api.dicebear.com/7.x/shapes/svg?seed=connector6',
        },
        {
          name: 'Vintage Bracket',
          quantity: 1,
          price: '0.15',
          image_url: 'https://api.dicebear.com/7.x/shapes/svg?seed=bracket7',
        },
      ],
    },
