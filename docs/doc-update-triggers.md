...
| **Solana-related code touched**   | `docs/solana-integration.md` if `config/solana.ts`, `appkit.service.ts`, or the Solana branch in `balance/swap/quote/pending-tx` changes |
